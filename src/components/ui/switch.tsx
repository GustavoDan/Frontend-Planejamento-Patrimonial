...
>(({ className, ...props }, ref) => (
    <SwitchPrimitives.Root
        className={cn(
            ...
            "data-[state=unchecked]:bg-[#6777FA]/20",
            "data-[state=checked]:bg-[#6777FA]/20",
            className
        )}
        {...props}
        ref={ref}
    >
        <SwitchPrimitives.Thumb
            className={cn(
                "pointer-events-none block h-3 w-3 rounded-full bg-[#6777FA] shadow-lg ring-0 transition-transform",
